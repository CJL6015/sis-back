...
public class HistoryController {
    ...
    @GetMapping("")
    public Result<List<Map<String, List<Object[]>>> > getHistory(String unitId, String st, String et, String points) {
        List<Map<String, List<Object[]>>>  history = historyService.getHistory(unitId, st, et, points);
